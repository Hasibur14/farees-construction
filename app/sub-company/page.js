  ...
  return (
      ...
      <section className="relative bg-gray-800 text-white">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center">
            <h1 className="text-white text-2xl md:text-3xl lg:text-4xl font-extrabold text-center ">
              {" "}
              M/S MAN ENTERPRISE{" "}
            </h1>
      ...
      <section className="py-10 sm:py-16 lg:py-24">
        <div className="max-w-[1400px] px-4 lg:mx-auto sm:px-6 lg:px-8">
          <div className="grid items-center grid-cols-1 gap-y-6 md:grid-cols-2 md:gap-x-20">
            <div className="">
              <h2 className="text-2xl md:text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl mb-4">
                M/S MAN ENTERPRISE
              </h2>
              <div className="text-justify text-[15px] md:text-md">
                <p>
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div class="grid grid-cols-1 gap-6 mt-12 lg:mt-16 xl:gap-10 sm:grid-cols-2 lg:grid-cols-3">
            <div class="overflow-hidden bg-white rounded shadow h-52">
                <div class="p-8">
                    <div class="flex items-center h-10">
                        <img class="flex-shrink-0 w-12 " src="https://www.onlinelogomaker.com/blog/wp-content/uploads/2017/06/Construction-Logos.jpg" alt="" />
