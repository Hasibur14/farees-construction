      ...
      <section className="relative bg-gray-800 text-white">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center">
            <h1 className="text-white text-2xl md:text-4xl font-extrabold">Our Projects</h1>
          ...
          <div className="max-w-[1400px]  mx-auto sm:px-6 lg:px-8">
            <div className="mb-5 md:flex justify-between items-center">
              <input
                ...
                className="p-2 border w-72 rounded mb-4 md:mb-0"
              />
              <select
                value={filterLetter}
                ...
                <div key={index}>
                  <div className="relative h-[300px] overflow-hidden rounded-md">
                    ...
                    <div className="absolute bottom-0 p-5 border-b-4 border-green-700 w-full hover:bg-green-900 hover:bg-opacity-50 duration-1000">
                      <h2 className="text-xl md:text-2xl text-white font-bold">{project.name}</h2>
                      <div className="flex gap-2 mt-2  md:mt-10">
                        <p className="border text-[12px] md:text-base border-white text-white rounded-full px-5 py-2">
                          Construction
                        </p>
                        <p className="border text-[12px] md:text-base border-white text-white rounded-full px-5 py-2">
                          Recent Works
