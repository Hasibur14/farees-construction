        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div>
            <div className="mt-14">
              ...
              <div className="flex bg-black p-4 lg:w-[80%] h-20 rounded-md text-center justify-center mt-4">
                <img src="https://templates.hibootstrap.com/constik/default/assets/img/icons/architect.png"></img>
                <h1 className="text-white font-extrabold text-xl mt-[10px]  ml-6">
                  Project Planning
                </h1>
              </div>

              <div className="flex bg-black p-4 lg:w-[80%] h-20 rounded-md justify-center mt-4">
