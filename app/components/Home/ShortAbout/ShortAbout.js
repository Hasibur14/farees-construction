          ...
          <div>
            ...
            <div>
              <Link
                href="/about"
                aria-label=""
                className="inline-flex items-center  font-semibold transition-colors duration-200  bg-black hover:bg-green-500 text-white p-3 w-52 flex justify-center rounded-full mt-8"
              >
                Explore More
                <svg
